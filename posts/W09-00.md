...
I think I like the idea of a portfolio as a back up if I can't make the other one work, or if this one is just more feasible to create. But make it a collaborative one. Could perhaps do 3 people, 3 pre-prepared works and each person gets 2 minutes to add their preprepared piece/case study to add into one page and in those 2 minutes they also get to create stylistic choices on the fly/if they also have something pre-prepared. After the 2 minutes it gets passed on to the next person, and by the end there will be a collaborative portfolio done at the end. I thought it'd be interesting to do a portfolio as its a pretty mundane activity for any design student; basically their CV. The only restraints would that I'd have to find 2 other people that can code to create this. It could be possible to limit it down to 2 people, but I think it'd produce more interesting results with 3 people. In terms of technicality, this one would be more difficult (would need to consider platform, one that all parties are comfortable with and everyone would need some level of preparation of material), however would be easier to execute once the logistics are done considering this can be done in peoples' own time. Whereas the other idea would be easier to prepare for, but it would be more difficult to get everyone together to execute before the end of semester/the due date of the assignment.
