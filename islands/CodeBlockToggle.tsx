    ...
    const addToggleButtons = () => {
      ...
      codeBlocks.forEach((pre) => {
        ...
        toggleButton.innerHTML =
          "<span style=\"font-family: 'Fira Code', monospace; font-variant-ligatures: normal;\">&lt;=&gt;</span>";
        ...
        toggleButton.addEventListener("click", (e) => {
          ...
          if (ligaturesOn) {
            ...
            toggleButton.innerHTML =
              "<span style=\"font-family: 'Fira Code', monospace; font-variant-ligatures: none;\">&lt;=&gt;</span>";
          }
        });
